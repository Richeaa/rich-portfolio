  ...
  return (
    <section id="skills" className="md:py-12">
      <div className="container mx-auto px-6 lg:mt-36 mt-16">
        <h2 className="md:text-5xl text-4xl font-extrabold text-center text-sky-200 pt-6">Skills</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 md:gap-12 mt-16 md:mt-12">
          {skills.map((skill, index) => (
            <div key={index} className="flex flex-col items-center justify-center p-4 bg-slate-800 bg-opacity-75 rounded-lg shadow-md">
